define([], function() {
  ...
  util.circularNeighbours = function(a, b, list) {
  ...
  util.splitRandomNode = function(graph) {
  ...
  util.convexPoints = function(num, mid, radius) {
  ...
  util.addRandomEdge = function(graph) {
    /* Possible improvements:
